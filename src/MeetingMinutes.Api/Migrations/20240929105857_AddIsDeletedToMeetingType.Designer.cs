...
namespace MeetingMinutes.Api.Migrations
{
    ...
    [Migration("20240929105857_AddIsDeletedToMeetingType")]
    partial class AddIsDeletedToMeetingType
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MeetingMinutes.DAL.Entities.Action", b =>
                {
            ...
            modelBuilder.Entity("MeetingMinutes.DAL.Entities.Item", b =>
                {
                    b.Property<int>("ItemId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MeetingMinutes.DAL.Entities.ItemStatus", b =>
                {
            ...
            modelBuilder.Entity("MeetingMinutes.DAL.Entities.Meeting", b =>
                {
            ...
            modelBuilder.Entity("MeetingMinutes.DAL.Entities.MeetingItem", b =>
                {
            ...
            modelBuilder.Entity("MeetingMinutes.DAL.Entities.MeetingType", b =>
                {
                    b.Property<int>("MeetingTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MeetingMinutes.DAL.Entities.Option", b =>
                {
            ...
            modelBuilder.Entity("MeetingMinutes.DAL.Entities.Question", b =>
                {
                    b.Property<int>("QuestionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MeetingMinutes.DAL.Entities.Role", b =>
                {
            ...
            modelBuilder.Entity("MeetingMinutes.DAL.Entities.Status", b =>
                {
                    b.Property<int>("StatusId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MeetingMinutes.DAL.Entities.UserRole", b =>
                {
            ...
            modelBuilder.Entity("MeetingMinutes.DAL.Entities.UserVote", b =>
                {
            ...
            modelBuilder.Entity("MeetingMinutes.DAL.Entities.Action", b =>
                {
                    b.HasOne("MeetingMinutes.DAL.Entities.Item", "Item")
                        .WithMany("Actions")
            ...
            modelBuilder.Entity("MeetingMinutes.DAL.Entities.ItemStatus", b =>
                {
                    ...
                    b.HasOne("MeetingMinutes.DAL.Entities.Status", "Status")
                        .WithMany("ItemStatuses")
            ...
            modelBuilder.Entity("MeetingMinutes.DAL.Entities.Meeting", b =>
                {
                    b.HasOne("MeetingMinutes.DAL.Entities.MeetingType", "MeetingType")
                        .WithMany("Meetings")
            ...
            modelBuilder.Entity("MeetingMinutes.DAL.Entities.MeetingItem", b =>
                {
                    b.HasOne("MeetingMinutes.DAL.Entities.User", "ActionByNavigation")
                    ...
                    b.HasOne("MeetingMinutes.DAL.Entities.ItemStatus", "ItemStatus")
                        .WithMany("MeetingItems")
                        .HasForeignKey("ItemStatusId")
                        .IsRequired()
                        .HasConstraintName("FK__MeetingIt__ItemS__5FB337D6");

                    b.HasOne("MeetingMinutes.DAL.Entities.Meeting", "Meeting")
                        .WithMany("MeetingItems")
            ...
            modelBuilder.Entity("MeetingMinutes.DAL.Entities.Option", b =>
                {
                    b.HasOne("MeetingMinutes.DAL.Entities.Question", "Question")
                        .WithMany("Options")
            ...
            modelBuilder.Entity("MeetingMinutes.DAL.Entities.Question", b =>
                {
                    b.HasOne("MeetingMinutes.DAL.Entities.User", "User")
                        .WithMany("Questions")
            ...
            modelBuilder.Entity("MeetingMinutes.DAL.Entities.UserRole", b =>
                {
                    b.HasOne("MeetingMinutes.DAL.Entities.Role", "Role")
                        .WithMany("UserRoles")
            ...
            modelBuilder.Entity("MeetingMinutes.DAL.Entities.UserVote", b =>
                {
                    b.HasOne("MeetingMinutes.DAL.Entities.Option", "Option")
                        .WithMany("UserVotes")
